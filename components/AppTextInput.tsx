    ...
    >
      ...
      {icon && (
        <MaterialCommunityIcons
          ...
          size={28}
          color={colors.dark}
          style={[styles.icon, label && { marginTop: 8, marginBottom: -8 }]}
        />
      )}
      <TextInput
        value={value}
      ...
      {secureTextEntry && (
        <TouchableOpacity
          onPress={() => setSecureTextEntryType(!secureTextEntryType)}
        >
          <MaterialCommunityIcons
      ...
      {maxLength && (
        <Text
          style={[
            styles.maxLength,
            {
              color: value?.length === maxLength ? colors.delete : colors.dark,
            },
          ]}
